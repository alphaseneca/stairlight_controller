...
const int lower_pir_pin = D0;   // Set the lower_pir_pin
const int upper_pir_pin = D5;   // Set the upper_pir_pin
...
void loop() {
  ...
  digitalWrite(LED_BUILTIN, HIGH);      // Activate the on_board led
